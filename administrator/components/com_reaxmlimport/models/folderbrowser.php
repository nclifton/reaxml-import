...
class ReaXmlImportModelsFolderbrowser extends JModelBase {
	...
	public function getSelectSubFolderUrl($key = 'item1'){
		return $this->currenturi
        . '?option=com_reaxmlimport&controller=config&view=folderbrowser&tmpl=component&inputid='
        . $this->inputid . '&urlinputid='.$this->getUrlinputid().'&folder=' . $this->getSubFolderPathUri ( $key );
	}
