 ...
 */
class UUtilAmazons3 extends UAbstractObject
{
	// ACL flags
	...
	public static function &getInstance($accessKey = null, $secretKey = null, $useSSL = true)
	{
		...
		{
			$instance = new static($accessKey, $secretKey, $useSSL);
		}
	...
	public static function putObject($input, $bucket, $uri, $acl = self::ACL_PRIVATE, $metaHeaders = array(), $requestHeaders = array())
	{
		...
		$rest = new AEUtilsS3Request('PUT', $bucket, $uri, UUtilAmazons3::getInstance()->defaultHost);
	...
	public static function startMultipart($input, $bucket, $uri, $acl = self::ACL_PRIVATE, $metaHeaders = array(), $requestHeaders = array())
	{
		...
		$rest = new AEUtilsS3Request('POST', $bucket, $uri, UUtilAmazons3::getInstance()->defaultHost);
	...
	public static function uploadMultipart($input, $bucket, $uri, $acl = self::ACL_PRIVATE, $metaHeaders = array(), $requestHeaders = array())
	{
		...
		$rest = new AEUtilsS3Request('PUT', $bucket, $uri, 's3.amazonaws.com', UUtilAmazons3::getInstance()->defaultHost);
	 ...
	 * @param int    $from   Which byte to start downloading from. Use null to start from the beginning.
	 * @param int    $to     Which byte to stop downloading at. Use null to download until the end of the file.
	 *
	 * @return mixed
	 */
	public static function getObject($bucket, $uri, $saveTo = false, $from = null, $to = null)
	{
		$rest = new AEUtilsS3Request('GET', $bucket, $uri, UUtilAmazons3::getInstance()->defaultHost);
		if ($saveTo !== false)
		{
	...
	{
		$rest = new AEUtilsS3Request('DELETE', $bucket, $uri, UUtilAmazons3::getInstance()->defaultHost);
	...
	*/
	public static function getBucket($bucket, $prefix = null, $marker = null, $maxKeys = null, $delimiter = null, $returnCommonPrefixes = false)
	{
		...
		$rest = new AEUtilsS3Request('GET', $bucket, '', UUtilAmazons3::getInstance()->defaultHost);
	...
	{
		$rest = new AEUtilsS3Request('GET', '', '', UUtilAmazons3::getInstance()->defaultHost);
		$rest = $rest->getResponse();
...
final class AEUtilsS3Request
{
	...
	public function getResponse()
	{
		...
		$url = ((UUtilAmazons3::$useSSL && extension_loaded('openssl')) ?
		...
		$headers[] = 'Authorization: ' . UUtilAmazons3::__getSignature($stringToSign);
