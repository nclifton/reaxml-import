...
/**
 * MySQL classic driver for UNITE Engine
 */
class UDriverMysql extends UAbstractDriver
{
	...
	public function select($database)
	{
		...
		if (!mysql_select_db($database, $this->resource))
		{
			...
			elseif (!mysql_select_db($database, $this->resource))
			{
				$this->errorNum = 3;
	 ...
	 *
	 * @param int $numinarray Which column to load
	 *
