...
class ReaxmlEzrColImage_fname_Test extends PHPUnit_Framework_TestCase {
	...
	public function getValue0_isnew_notfound_givesempty() {
		...
		// Act
		$col = new ReaxmlEzrColImage_fname ( $xml, $dbo, null, $row );
	...
	public function getValue1_isnew_notfound_givesempty() {
		...
		// Act
		$col = new ReaxmlEzrColImage_fname ( $xml, $dbo, null, new ReaxmlEzrRow ( $xml, $dbo ) );
	 ...
	 * @test
	 */
	public function getValue0_file_copiesfile_givesfilename_generatesthumb() {
		// Arrange
		...
		// Act
		$col = new ReaxmlEzrColImage_fname ( $xml, $dbo, $configuration, new ReaxmlEzrRow ( $xml, $dbo ) );
		$value = $col->getValueAt ( 0 );
	 ...
	 * @test
	 */
	public function getValue0_url_copiesfile_givesfilename_generatesthumb() {
		// Arrange
