 ...
 **/ 
class ReaxmlEzrColOhendtime2_Test extends PHPUnit_Framework_TestCase {
	...
	public function getValue_found_gives_time() {
		...
		// Act
		$col = new ReaxmlEzrColOhendtime2 ( new ReaxmlEzrRow ( $xml ) );
		$value = $col->getValue ();
		
		// Assert
		$this->assertThat ( $value, $this->equalto ( '12:30:00' ) );
	}
	/**
	 * @test
	 */
