...
class ReaxmlEzrColImage_ordering_Test extends PHPUnit_Framework_TestCase {
	...
	public function getValue0_isnew_notfound_gives1() {
		...
		// Act
		$col = new ReaxmlEzrColImage_ordering ( new ReaxmlEzrRow ( $xml, $dbo, null, new ReaxmlEzrRow($xml, $dbo) ) );
	...
	public function getValue0_idm_gives1() {
		...
		// Act
		$col = new ReaxmlEzrColImage_ordering ( new ReaxmlEzrRow ( $xml , null, null, new ReaxmlEzrRow($xml, null) ) );
		$value = $col->getValueAt (0);
