...
class ReaxmlEzrColPdfinfo2_Test extends PHPUnit_Framework_TestCase {
	...
	public function getValue_isnew_notfound_givesempty() {
		...
		// Act
		$col = new ReaxmlEzrColPdfinfo2 ( new ReaxmlEzrRow ( $xml, $dbo ) );
		$value = $col->getValue ();
	...
	public function getValue_file_copiesfile_givesfilename() {
		...
		// Act
		$col = new ReaxmlEzrColPdfinfo2 ( new ReaxmlEzrRow ( $xml, null, $configuration ) );
		$value = $col->getValue ();
	...
	public function getValue_url_copiesfile_givesfilename() {
		...
		// Act
		$col = new ReaxmlEzrColPdfinfo2 ( new ReaxmlEzrRow ( $xml ) );
		$value = $col->getValue ();
