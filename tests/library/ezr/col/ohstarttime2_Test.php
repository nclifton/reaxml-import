 ...
 **/ 
class ReaxmlEzrColOhstarttime2_Test extends PHPUnit_Framework_TestCase {
	...
	public function getValue_found_gives_time() {
		...
		// Act
		$col = new ReaxmlEzrColOhstarttime2 ( new ReaxmlEzrRow ( $xml ) );
		$value = $col->getValue ();
		
		// Assert
		$this->assertThat ( $value, $this->equalto ( '10:30:00' ) );
	}
	/**
	 * @test
	 */
