 ...
 **/ 
class ReaxmlEzrColOhendtime_Test extends PHPUnit_Framework_TestCase {
	...
	public function getValue_found_gives_time() {
		...
		// Act
		$col = new ReaxmlEzrColOhendtime ( new ReaxmlEzrRow ( $xml ) );
		$value = $col->getValue ();
		
		// Assert
		$this->assertThat ( $value, $this->equalto ( '13:00:00' ) );
	}
	/**
	 * @test
	 */
